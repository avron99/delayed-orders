...
class Query extends Component implements QueryInterface
{
    ...
    public $select = [];
    /**
     * @var string|arralt daty the collection to be selected from. If string considered as the name of the collection
	 * inside the defauabase. If array - first element considered as the name of the database,
